...
(function () {
    ...
    //     const ageMonths = currentMonth - birthDay;
    //     const ageYears = currentYear - birthYear;

    //     // Printing age in years to a elements with an id of 'age'
    //     document.querySelectorAll('#age').forEach((item) => item.innerHTML = `${ageYears} and ${ageMonths}`);
    // }
    ...
    // Listen for the custom event and call the age function
    document.addEventListener('changeLanguageCalled', () => {
        age(21, 5, 2006);
    });
